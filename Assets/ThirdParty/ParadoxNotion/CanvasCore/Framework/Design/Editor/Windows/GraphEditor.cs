...
namespace NodeCanvas.Editor
{
    ...
    public partial class GraphEditor : EditorWindow
    {
        ...
        public static void PingElement(IGraphElement element) {
            ...
            if ( element is Framework.Connection ) { PingRect(( element as Framework.Connection ).GetMidRect()); }
        }
        ...
        public static void FocusElement(IGraphElement element, bool alsoSelect = false) {
            ...
            if ( element is Framework.Connection ) { FocusConnection((Framework.Connection)element, alsoSelect); }
        }
        ...
        public static void FocusConnection(Framework.Connection connection, bool alsoSelect = false) {
